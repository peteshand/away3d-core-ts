...
module away.display {
    ...
    export class BitmapData
    {
        ...
        private _drawImage( img : any , sourceRect : away.geom.Rectangle , destRect:away.geom.Rectangle ):void
        {
            ...
            {
				var bmd:away.display.BitmapData = <away.display.BitmapData>img;
                this._context.drawImage(bmd.canvas , sourceRect.x ,sourceRect.y,sourceRect.width,sourceRect.height,destRect.x,destRect.y,destRect.width,destRect.height );
            }
            else if ( img instanceof HTMLImageElement )
            {
				var image:HTMLImageElement = <HTMLImageElement>img;
        ...
        private _copyPixels( bmpd : any, sourceRect : away.geom.Rectangle , destRect:away.geom.Rectangle ):void
        {
            ...
            {
				var bmd:away.display.BitmapData = <away.display.BitmapData>bmpd;
                this._context.drawImage( bmd.canvas , sourceRect.x , sourceRect.y , sourceRect.width , sourceRect.height , destRect.x , destRect.y , destRect.width , destRect.height );
            }
            else if ( bmpd instanceof HTMLImageElement )
            {
				var image:HTMLImageElement = <HTMLImageElement>bmpd;
                this._context.drawImage( image , sourceRect.x , sourceRect.y , sourceRect.width , sourceRect.height , destRect.x , destRect.y , destRect.width , destRect.height );
            }
        ...
        private _draw (source : any , matrix : away.geom.Matrix ) : void
        {
            ...
            {
				var bmd:away.display.BitmapData = <away.display.BitmapData>source;
                this._context.save();
                this._context.setTransform(matrix.a, matrix.b, matrix.c, matrix.d, matrix.tx, matrix.ty);
                this._context.drawImage(bmd.canvas, 0, 0)
                this._context.restore();

            }
            else if ( source instanceof HTMLImageElement )
            {
				var image:HTMLImageElement = <HTMLImageElement>source;
                this._context.save();
                this._context.setTransform(matrix.a, matrix.b, matrix.c, matrix.d, matrix.tx, matrix.ty);
